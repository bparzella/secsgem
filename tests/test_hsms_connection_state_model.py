...
class TestSecsConnectionStateModelPassive(unittest.TestCase):
    ...
    def testInitialState(self):
        self.assertEqual(self.client.protocol.connectionState.state, secsgem.hsms.connectionstatemachine.STATE_NOT_CONNECTED)

    def testConnect(self):
        self.server.simulate_connect()

        self.assertEqual(self.client.protocol.connectionState.state, secsgem.hsms.connectionstatemachine.STATE_CONNECTED_NOT_SELECTED)
    ...
    def testSelection(self):
        ...
        self.assertEqual(self.client.protocol.connectionState.state, secsgem.hsms.connectionstatemachine.STATE_CONNECTED_SELECTED)
