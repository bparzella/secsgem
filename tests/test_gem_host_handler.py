...
class TestGemHostHandlerPassive(unittest.TestCase, GemHandlerPassiveGroup):
    ...
    def subscribeCollectionEvent(self, ceid, dvs, report_id):
        ...
        packet = self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS02F36(self.data_items.LRACK.ACK), packet.header.system)
        self.settings.protocol.simulate_message(packet)
    ...
    def sendRemoteCommand(self, params):
        ...
        packetdata = {"HCACK": self.data_items.HCACK.INVALID_COMMAND, "PARAMS": [{"CPNAME": "PARAM1", "CPACK": self.data_items.CPACK.CPVAL_ILLEGAL_VALUE}, {"CPNAME": "PARAM2", "CPACK": self.data_items.CPACK.CPVAL_ILLEGAL_FORMAT}]}
    ...
    def testDeleteProcessPrograms(self):
        ...
        packet = self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS07F18(self.data_items.ACKC7.ACCEPTED), packet.header.system)
        self.settings.protocol.simulate_message(packet)
    ...
    def testGoOnline(self):
        ...
        packet = self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS01F18(self.data_items.ONLACK.ACCEPTED), packet.header.system)
        self.settings.protocol.simulate_message(packet)
    ...
    def testGoOffline(self):
        ...
        packet = self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS01F16(self.data_items.OFLACK.ACK), packet.header.system)
        self.settings.protocol.simulate_message(packet)
    ...
    def testEnableAlarm(self):
        ...
        self.assertEqual(function.ALED.get(), self.data_items.ALED.ENABLE)
        self.assertEqual(function.ALID.get(), 25)

        packet = self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS05F04(self.data_items.ACKC5.ACCEPTED), packet.header.system)
        self.settings.protocol.simulate_message(packet)
    ...
    def testDisableAlarm(self):
        ...
        self.assertEqual(function.ALED.get(), self.data_items.ALED.DISABLE)
        self.assertEqual(function.ALID.get(), 25)
    ...
    def testReceiveAlarm(self):
        ...
        self.settings.protocol.simulate_message(self.settings.protocol.create_message_for_function(secsgem.secs.functions.SecsS05F01({"ALCD": self.data_items.ALCD.PERSONAL_SAFETY | self.data_items.ALCD.ALARM_SET, "ALID": 100, "ALTX": "text"}), system_id))
